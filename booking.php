  ...
  <div class="container">
    ...
    <form class="form-horizontal" method="post" action="" novalidate>  <!-- Form start -->
      ...
      <div class="form-group row"> <!-- Submit section end -->
        <div class="col-sm-12">
          <button type="submit" class="btn btn-success center-block" name="submit"><a href="success.php">Submit <i class="fas fa-arrow-right"></i></a></button>
        </div>
...
.iti-flag {
  background-image: url("../resources/library/tel/img/flags.png");
}
