...
$message .= "<tr><td><strong>First Name:</strong> </td><td>" . strip_tags($_POST['firstname']) ? $_POST['firstname'] : '' ."</td></tr>";
$message .= "<tr><td><strong>Last Name:</strong> </td><td>" . strip_tags($_POST['lastname']) ? $_POST['lastname'] : '' . "</td></tr>";
$message .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['email']) ? $_POST['email'] : '' . "</td></tr>";
$message .= "<tr><td><strong>Phone Number:</strong> </td><td>" . strip_tags($_POST['phone']) ? $_POST['phone'] : '' . "</td></tr>";
$message .= "<tr><td><strong>Number of Guests:</strong> </td><td>" . $_POST['guests'] ? $_POST['guests'] : '' . "</td></tr>";
$message .= "<tr><td><strong>Date / Time:</strong> </td><td>" . strip_tags($_POST['date']) ? $_POST['date'] : '' . " " . strip_tags($_POST['time']) ? $_POST['time'] : '' . "</td></tr>";
...
if ($reservation === 'Other') {
   $message .= "<tr><td><strong>Additional comment:</strong> </td><td>" . strip_tags($_POST['other-reservation-comment']) ? $_POST['other-reservation-comment'] : '' . "</td></tr>";
}
